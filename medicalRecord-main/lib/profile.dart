...
class Profile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(textDirection: TextDirection.rtl,
      child: Scaffold(
        appBar: AppBar(title: const Text('الملف الشخصي',style: TextStyle(fontSize: 20),),elevation: 0,backgroundColor: button,leading: IconButton(onPressed: (){Navigator.pop(context);},icon: const Icon(Icons.arrow_back_ios_sharp,color: Colors.white,),),),
        body: Container(
                  ...
                  Container(
                      ...
                      child: Padding(
                        ...
                        child: RichText(
                            text: const TextSpan(
                                text:
                                    "ftttthhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhtttt",
